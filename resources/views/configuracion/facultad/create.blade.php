            ...
            <div class="card-body">
                <form action="/facultad" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            <input id="fac_nombre" type="text" class="form-control @error('fac_nombre') is-invalid @enderror" name="fac_nombre" value="{{ old('fac_nombre') }}" autocomplete="fac_nombre">
                            @error('fac_nombre')
                    ...
                    <div class="row mb-3">
                        <label for="fac_status"
                            class="col-md-12 col-form-label text-md-right">{{ __('Status *') }}</label>
                        <div class="col-md-12">
                            <select class="form-select" name="fac_status" id="fac_status">
