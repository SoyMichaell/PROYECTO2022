...
@section('content')
    <div class="fondo">
        <div class="container p-3">
            <h3><i class="fas  fa-city"></i> Departamentos / inico</h3>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex justify-content-end align-items-center">
                        <a class="btn btn-primary btn-sm space-btn" href="{{ url('departamento/create') }}"><i
                                class="fas fa-plus-circle"></i>
                            Nuevo</a>
                        <a class="btn btn-info btn-sm btn-eye" href="{{url('departamento/pdf')}}" title="Generar reporte pdf" target="__blank"><i
                        ...
                        <tbody>
                            ...
                            @foreach ($departamentos as $departamento)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{url("departamento/{$departamento->id}")}}"
                                            method="POST">
                                            <div class="d-flex">
                                                <a class="btn btn-eye btn-sm space-btn" href="/departamento/{{ $departamento->id }}"><i
