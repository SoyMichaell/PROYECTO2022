...
@section('content')
    ...
    <div class="container">
        <div class="card card-create w-100">
            <div class="card-header"><i class="fas fa-sync-alt"></i> Editar registro</div>
            <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_estado_programa" id="pro_estado_programa">
                                    ...
                                    @foreach ($estadoprogramas as $estadoprograma)
                                        <option value="{{ $estadoprograma->id }}" {{$estadoprograma->id == $programa->pro_estado_programa ? 'selected' : '' }}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_departamento" id="pro_departamento">
                                    ...
                                    @foreach ($departamentos as $departamento)
                                        <option value="{{ $departamento->id }}" {{$departamento->id == $programa->pro_departamento ? 'selected' : ''}}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_municipio" id="pro_municipio">
                                    ...
                                    @foreach ($municipios as $municipio)
                                        <option value="{{ $municipio->id }}" {{$municipio->id == $programa->pro_municipio ? 'selected' : ''}}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_facultad" id="pro_facultad">
                                    ...
                                    @foreach ($facultades as $facultad)
                                        <option value="{{$facultad->id}}" {{$facultad->id == $programa->pro_facultad ? 'selected' : ''}}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="pro_nombre" type="text"
                                    ...
                                    value="{{ $programa->pro_nombre }}" required autocomplete="pro_nombre" autofocus>
                                @error('pro_nombre')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="pro_titulo" type="text"
                                    ...
                                    value="{{ $programa->pro_titulo }}" required autocomplete="pro_titulo" autofocus>
                                @error('pro_titulo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_nivel_formacion" id="pro_nivel_formacion">
                                    ...
                                    @foreach ($niveles as $nivel)
                                        <option value="{{$nivel->id}}" {{$nivel->id == $programa->pro_nivel_formacion ? 'selected' : ''}}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_programa_ciclos" id="pro_programa_ciclos">
                                    ...
                                    @foreach ($programasCiclo as $programaCiclo)
                                        <option value="{{$programaCiclo->id}}" {{$programaCiclo->id == $programa->pro_programa_ciclos ? 'selected' : ''}}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_metodologia" id="pro_metodologia">
                                    ...
                                    @foreach ($metodologias as $metodologia)
                                        <option value="{{$metodologia->id}}" {{$metodologia->id == $programa->pro_metodologia ? 'selected' : ''}}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_duraccion" id="pro_duraccion">
                                    ...
                                    @foreach ($tiemposList as $tiempoList)
                                        <option value="{{$tiempoList->id}}" {{$tiempoList->id == $programa->pro_duraccion ? 'selected' : ''}}>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="pro_periodo" id="pro_periodo">
                                    ...
                                    @foreach ($periodos as $periodo)
                                        <option value="{{$periodo->id}}" {{$periodo->id == $programa->pro_periodo ? 'selected' : ''}}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="pro_creditos" type="number"
                                    ...
                                    value="{{ $programa->pro_creditos }}" required autocomplete="pro_creditos" autofocus>
                                @error('pro_creditos')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="pro_norma" type="text"
                                    ...
                                    value="{{ $programa->pro_norma }}" required autocomplete="pro_norma" autofocus>
                                @error('pro_norma')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <input id="pro_director_programa" type="text"
                                    ...
                                    autocomplete="pro_director_programa" autofocus>
